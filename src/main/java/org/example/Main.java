...
public class Main implements Map{
...
//Переписываем все методы интерфейса Map
    //Первый метод Clear создает новый массив, а старый удалит сборщик муссора,
    //т.к. на него бошльше не будет ссылки
    @Override
    public void clear() {
    ...
    private boolean put(K key, V value, Entry[] dst) {
    //Так же получаем позицию элмента
    ...
    //Метод получения позиции элмента
